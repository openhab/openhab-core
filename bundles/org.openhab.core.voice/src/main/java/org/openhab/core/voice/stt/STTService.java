 ...
 */
package org.openhab.core.voice.stt;
...
public interface STTService {
    ...
    /**
     * Get the Locales available from this STTService.
     *
    ...
    /**
     * Get the audio formats supported by this STTService.
     *
     ...
     * @param sttListener The {@link STTListener} that {@link STTEvent} events target
     ...
     * @throws STTException if any parameter is invalid or an STT problem occurs
     */
    STTServiceHandle recognize(STTListener sttListener, AudioStream audioStream, Locale locale) throws STTException;
}
