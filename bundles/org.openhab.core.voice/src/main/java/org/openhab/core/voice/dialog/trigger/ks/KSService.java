 ...
 */
package org.openhab.core.voice.dialog.trigger.ks;
...
public interface KSService extends DTService {
    /**
     * Get the Locales available from this KSService
     *
    ...
    /**
     * Get the audio formats supported by this KSService
     *
     ...
     *
     * @implNote The method is supposed to return fast, i.e., it should only start the spotting as a background process.
     *
     ...
     * @param keyword The keyword to spot
