 ...
 */
package org.openhab.core.voice.tts;
...
public interface TTSCache {
    ...
    /**
     * Returns an {@link AudioStream} containing the TTS results.
     *
     * <p>
     * Upon requesting an unsupported {@code Voice} or {@link AudioFormat}, a {@link TTSException} is thrown.
     *
     * <p>
     * The AudioStream is requested from the cache, or, if not found, from the underlying TTS service.
     *
