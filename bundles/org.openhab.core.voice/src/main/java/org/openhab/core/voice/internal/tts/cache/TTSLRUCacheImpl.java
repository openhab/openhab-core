...
import org.openhab.core.voice.tts.CachedTTSService;
...
/**
 * Cache system to avoid requesting {@link org.openhab.core.voice.tts.TTSService} for the same utterances.
 * This is an LRU cache (the least-recently-used entry is evicted if the size is exceeded).
