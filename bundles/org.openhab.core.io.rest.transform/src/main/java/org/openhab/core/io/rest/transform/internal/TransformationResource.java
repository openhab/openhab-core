...
public class TransformationResource implements RESTResource {
    ...
    public  @Nullable Response getTransformation(@PathParam("uid") @Parameter(description = "Transformation UID") String uid) {
        logger.debug("Received HTTP GET request at '{}'", uriInfo.getPath());
    ...
    public  @Nullable Response putTransformation(@PathParam("uid") @Parameter(description = "Transformation UID") String uid,
    ...
    @Operation(operationId = "deleteTransformation", summary = "Get a single transformation", responses = {
            ...
            @ApiResponse(responseCode = "405", description = "Transformation not editable") })
    public  @Nullable Response deleteTransformation(@PathParam("uid") @Parameter(description = "Transformation UID") String uid) {
