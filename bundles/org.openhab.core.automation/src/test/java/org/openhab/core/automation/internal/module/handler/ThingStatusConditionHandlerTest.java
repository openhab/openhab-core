 ...
 *
 * @author Jörg Sautter - Initial contribution based on ThingStatusConditionHandlerTest
 */
...
public class ThingStatusConditionHandlerTest extends JavaTest {
    ...
    public static class ParameterSet {
        ...
        public ParameterSet(String comparisonState, ThingStatus thingStatus, boolean expectedResult) {
            ...
            this.comparisonStatus = comparisonState;
