...
/**
 * {@link SemanticTagParser} is the interface to implement by any {@link SemanticTag} parser.
 *
 * @author Laurent Garnier - Initial contribution
 */
@NonNullByDefault
public interface SemanticTagParser extends ObjectParser<SemanticTag> {

    /**
     * Parse the provided {@code syntax} string without impacting the semantic tag registry.
     *
    ...
    /**
     * Get the {@link SemanticTag} objects found when parsing the format.
     *
     * @param modelName the model name used when parsing.
     * @return The {@link Collection} of {@link SemanticTag}s.
     */
    @Override
    Collection<SemanticTag> getParsedObjects(String modelName);
}
