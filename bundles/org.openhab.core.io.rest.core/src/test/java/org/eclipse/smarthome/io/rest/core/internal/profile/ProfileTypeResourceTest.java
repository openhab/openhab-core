 ...
 *
 */
public class ProfileTypeResourceTest {
    ...
    public void setup() {
        ...
        ressource.channelTypeRegistry = (ctRegistry);
        ressource.profileTypeRegistry = (ptRegistry);
    }

    @Test
    public void testGetAll() {
        Stream<ProfileTypeDTO> result = ressource.getAll(null, null, null);
    ...
    public void testGetProfileTypesForStateChannel1() {
        Stream<ProfileTypeDTO> result = ressource.getAll(null, pt1ChannelType1UID.toString(), null);
        List<ProfileTypeDTO> list = result.collect(Collectors.toList());
    ...
    public void testGetProfileTypesForOtherChannel() {
        Stream<ProfileTypeDTO> result = ressource.getAll(null, otherStateChannelTypeUID.toString(), null);
        List<ProfileTypeDTO> list = result.collect(Collectors.toList());
    ...
    public void testGetProfileTypesForTriggerChannel1() {
        Stream<ProfileTypeDTO> result = ressource.getAll(null, pt3ChannelType1UID.toString(), null);
        List<ProfileTypeDTO> list = result.collect(Collectors.toList());
    ...
    public void testGetProfileTypesForTriggerChannel2() {
        Stream<ProfileTypeDTO> result = ressource.getAll(null, otherTriggerChannelTypeUID.toString(), null);
        List<ProfileTypeDTO> list = result.collect(Collectors.toList());
