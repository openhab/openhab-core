...
public class ThreadPoolManagerTest {
    ...
    public static void enableSequentialScheduledExecutorService() {
        System.setProperty("org.openhab.core.common.SequentialScheduledExecutorService", "true");
    }
    ...
    public void testExecutionIsSequentialInSequentialExecutorService() {
        ScheduledExecutorService service = ThreadPoolManager.newSequentialScheduledExecutorService("unit-test",
                "thread-1");
    ...
    public void testInstancesDoNotBlockEachOtherInSequentialExecutorService() throws InterruptedException {
        ScheduledExecutorService serviceA = ThreadPoolManager.newSequentialScheduledExecutorService("unit-test",
                "thread-3");
        ScheduledExecutorService serviceB = ThreadPoolManager.newSequentialScheduledExecutorService("unit-test",
                "thread-4");
    ...
    public static void disableSequentialScheduledExecutorService() {
        System.setProperty("org.openhab.core.common.SequentialScheduledExecutorService", "false");
    }
}
