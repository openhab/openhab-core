...
public class ItemEventFactoryTest {
    ...
    public static final List<CommandTestCase> COMMAND_TEST_SOURCE = List.of(
            ...
            new CommandTestCase("ItemB", OnOffType.OFF, SOURCE, "{\"type\":\"OnOff\",\"value\":\"OFF\"}", OnOffType.OFF,
                    null),
            new CommandTestCase("ItemC", DateTimeType.valueOf("2012-04-08T18:23:12Pacific/Fiji"), SOURCE,
                    "{\"type\":\"DateTime\",\"value\":\"2012-04-08T18:23:12+12:00[Pacific/Fiji]\"}",
                    DateTimeType.valueOf("2012-04-08T18:23:12Pacific/Fiji"), null),
            new CommandTestCase("ItemD", DateTimeType.valueOf("?2012-04-08T18:23:12Pacific/Fiji"), SOURCE,
                    "{\"type\":\"DateTime\",\"value\":\"?2012-04-08T18:23:12+12:00[Pacific/Fiji]\"}",
                    DateTimeType.valueOf("2012-04-08T08:23:12+02:00[Europe/Paris]"), ZoneId.of("Europe/Paris")),
            new CommandTestCase("ItemE", DateTimeType.valueOf("?2012-04-08T18:23:12Pacific/Fiji"), SOURCE,
                    "{\"type\":\"DateTime\",\"value\":\"?2012-04-08T18:23:12+12:00[Pacific/Fiji]\"}",
    ...
    public static final List<StateTestCase> STATE_TEST_SOURCE = List.of(
            ...
            new StateTestCase("ItemD", DateTimeType.valueOf("?2019-11-11T13:50:23Pacific/Fiji"), SOURCE,
                    "{\"type\":\"DateTime\",\"value\":\"?2019-11-11T13:50:23+13:00[Pacific/Fiji]\"}",
                    DateTimeType.valueOf("2019-11-11T01:50:23+01:00[Europe/Paris]"), ZoneId.of("Europe/Paris")),
            new StateTestCase("ItemE", DateTimeType.valueOf("?2019-11-11T18:23:12Pacific/Fiji"), SOURCE,
    ...
    public static final List<StateChangedTestCase> STATE_CHANGED_TEST_SOURCE = List.of(new StateChangedTestCase("ItemA",
            ...
            new StateChangedTestCase("ItemB", new DateTimeType("?2019-11-11T09:40Z").toZone(ZoneId.of("Africa/Cairo")),
                    ...
                    DateTimeType.valueOf("2019-11-11T16:50:00+03:00[Africa/Addis_Ababa]"), null),
            new StateChangedTestCase("ItemC", DateTimeType.valueOf("?2019-11-11T10:20:27Pacific/Fiji"),
                    DateTimeType.valueOf("?2019-11-11T13:50:23Pacific/Fiji"),
                    ZonedDateTime.parse("2026-02-02T13:48:34-08:00"), ZonedDateTime.parse("2026-02-02T13:34:12-08:00"),
                    SOURCE,
                    ...
                    DateTimeType.valueOf("2019-11-10T22:20:27+01:00[Europe/Paris]"),
                    DateTimeType.valueOf("2019-11-11T01:50:23+01:00[Europe/Paris]"), ZoneId.of("Europe/Paris")),
            new StateChangedTestCase("ItemD", DateTimeType.valueOf("?2019-11-11T09:23:12Pacific/Fiji"),
                    DateTimeType.valueOf("?2019-11-11T18:23:12Pacific/Fiji"),
            ...
            new TimeSeriesTestCase("ItemA", Policy.ADD,
                    List.of(new TimeSeriesTestEntry(Instant.parse("2026-02-03T10:28:34Z"), OnOffType.OFF,
                            ...
                            new TimeSeriesTestEntry(Instant.parse("2026-02-03T10:28:38Z"),
                                    DateTimeType.valueOf("?2019-11-11T18:23:12Asia/Tbilisi"),
    ...
    public void testCreateEventItemStateEvent(StateTestCase testCase) throws Exception {
        ...
        ZonedDateTime zdt = ZonedDateTime.parse("2026-05-17T12:00:00+01:00[Europe/Paris]");
