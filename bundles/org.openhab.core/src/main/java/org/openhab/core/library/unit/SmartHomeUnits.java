...
public final class SmartHomeUnits extends CustomUnits {
    ...
    public static final Unit<Angle> DEGREE_ANGLE = addUnit("°", Units.RADIAN,
    ...
    public static final Unit<Intensity> IRRADIANCE = addUnit("W/m²",
            new ProductUnit<Intensity>(Units.WATT.divide(Units.SQUARE_METRE)));
    public static final Unit<Intensity> MICROWATT_PER_SQUARE_CENTIMETRE = addUnit("µW/cm²", IRRADIANCE, 1, 100);
    ...
    public static final Unit<Density> BECQUEREL_PER_CUBIC_METRE = addUnit("Bq/m³",
            new ProductUnit<Density>(Units.BECQUEREL.divide(Units.CUBIC_METRE)));
    ...
    public static final Unit<DataTransferRate> BIT_PER_SECOND = addUnit("bit/s",
    ...
    private static <U extends Unit<?>> U addUnit(U unit) {
        if (unit instanceof AlternateUnit) {
            SimpleUnitFormat.getInstance().label(unit, ((AlternateUnit<?>) unit).getSymbol());
        }
