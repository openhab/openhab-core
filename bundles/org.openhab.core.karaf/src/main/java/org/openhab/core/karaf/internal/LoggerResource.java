...
public class LoggerResource implements RESTResource {
    ...
    public  @Nullable Response putLoggers(@PathParam("loggerName") @Parameter(description = "logger name") String loggerName,
    ...
    public  @Nullable Response getLogger(@PathParam("loggerName") @Parameter(description = "logger name") String loggerName,
            @Context UriInfo uriInfo) {
    ...
    @Operation(operationId = "removeLogger", summary = "Remove a single logger.", responses = {
            @ApiResponse(responseCode = "200", description = "OK") })
    public  @Nullable Response removeLogger(@PathParam("loggerName") @Parameter(description = "logger name") String loggerName,
            @Context UriInfo uriInfo) {
