...
import static org.openhab.core.io.transport.sbus.ModbusConstants.*;
...
public class WriteRequestJsonUtilitiesTest {
    ...
    public void testEmptyArray() {
        assertThat(WriteRequestJsonUtilities.fromJson(1, 3, "[]").size(), is(equalTo(0)));
    }

    @Test
    public void testFC6NoRegister() {
        assertThrows(IllegalArgumentException.class, () -> WriteRequestJsonUtilities.fromJson(1, 55, "[{"//
                + "\"functionCode\": 6,"//
                + "\"address\": 5412,"//
                + "\"value\": []"//
                + "}]"));
    ...
    public void testFC6SingleRegister() {
        assertThat(WriteRequestJsonUtilities.fromJson(1, 55, "[{"//
                + "\"functionCode\": 6,"//
                + "\"address\": 5412,"//
                + "\"value\": [3]"//
                + "}]").toArray(),
    ...
    public void testFC16MultipleRegistersMaxRegisters() {
        Collection<ModbusWriteRequestBlueprint> writes = WriteRequestJsonUtilities.fromJson(1, 55, "[{"//
                + "\"functionCode\": 16,"//
                + "\"address\": 5412,"//
    ...
    public void testEmptyObject() {
        ...
        assertThrows(IllegalStateException.class, () -> WriteRequestJsonUtilities.fromJson(1, 3, "{}"));
    }

    @Test
    public void testNumber() {
        // we are expecting list, not primitive (number) -> error
        assertThrows(IllegalStateException.class, () -> WriteRequestJsonUtilities.fromJson(1, 3, "3"));
    }
