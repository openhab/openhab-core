...
public class ModbusWriteCoilRequestBlueprint extends ModbusWriteRequestBlueprint {
     ...
     */
    public ModbusWriteCoilRequestBlueprint(int subnetId, int slaveId, int reference, boolean data,
            boolean writeMultiple, int maxTries) {
        this(subnetId, slaveId, reference, new BitArray(data), writeMultiple, maxTries);
    }
