...
public final class WriteRequestJsonUtilities {
     ...
     */
    public static Collection<ModbusWriteRequestBlueprint> fromJson(int subnetId, int unitId, String jsonString) {
        ...
        jsonArray.forEach(writeElem -> {
            writes.add(constructBluerint(subnetId, unitId, writeElem));
        });
        return writes;
    }

    private static ModbusWriteRequestBlueprint constructBluerint(int subnetId, int unitId, JsonElement arrayElement) {
        ...
        return constructBluerint(subnetId, unitId, functionCode, address, maxTries, valuesElem);
    }

    private static ModbusWriteRequestBlueprint constructBluerint(int subnetId, int unitId,
            @Nullable JsonElement functionCodeElem, @Nullable JsonElement addressElem,
            @Nullable JsonElement maxTriesElem, @Nullable JsonArray valuesElem) {
        ...
        switch (functionCode) {
            ...
            case WRITE_MULTIPLE_COILS:
                ...
                return new ModbusWriteCoilRequestBlueprint(subnetId, unitId, address, bits, !writeSingle.get(),
                        maxTries);
            ...
            case WRITE_MULTIPLE_REGISTERS: {
                ...
                return new ModbusWriteRegisterRequestBlueprint(subnetId, unitId, address,
                        new ModbusRegisterArray(registers), !writeSingle.get(), maxTries);
            }
            default:
