...
public class ModbusReadRequestBlueprint {
    ...
    public ModbusReadRequestBlueprint(int subnetId, int slaveId, ModbusReadFunctionCode functionCode, int start,
            int length, int maxTries) {
     ...
     * <p>
     *
     * @return the subnet identifier as <tt>int</tt>.
     */
