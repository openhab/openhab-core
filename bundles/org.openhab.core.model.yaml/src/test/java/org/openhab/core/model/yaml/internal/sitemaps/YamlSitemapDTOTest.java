...
public class YamlSitemapDTOTest {
    ...
    public void testIsValid() throws IOException {
        ...
        assertEquals(
                ...
                err.getFirst());
        assertEquals("invalid sitemap \"%s\": \"widgets\" field missing while mandatory".formatted(sitemap.name),
                err.get(1));
        err.clear();
        sitemap.name = "demo";
        ...
        assertEquals(1, err.size());
        assertEquals(
                "invalid sitemap \"%s\": \"widgets\" field must define at least one widget".formatted(sitemap.name),
                err.getFirst());
        err.clear();
        sitemap.widgets = List.of(widgetText);
        assertTrue(sitemap.isValid(err, warn));
    ...
    public void testEquals() throws IOException {
        ...
        assertFalse(sitemap1.equals(sitemap2));
        sitemap2.widgets = List.of(widget4);
        assertFalse(sitemap1.equals(sitemap2));
