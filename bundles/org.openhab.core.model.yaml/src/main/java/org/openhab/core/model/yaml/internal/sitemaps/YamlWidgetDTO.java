...
public class YamlWidgetDTO {
    ...
    static {
        ...
        OPTIONAL_FIELDS.put(CHART, Set.of("service", "legend", "forceAsItem", "yAxisDecimalPattern", "interpolation"));
        ...
        if (visibility instanceof List<?> rules) {
            ...
            for (Object r : rules) {
                if (r instanceof YamlRuleWithAndConditionsDTO rule) {
                    ...
                    if (rule.value != null) {
                        addToList(warnings, "unexpected \"value\" field in visibility rule is ignored");
                    }
                    ...
                    addToList(errors, "invalid visibility rule");
                }
            }
