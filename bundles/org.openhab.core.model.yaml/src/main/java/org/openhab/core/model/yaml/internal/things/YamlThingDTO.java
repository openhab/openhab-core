...
public class YamlThingDTO implements YamlElement, Cloneable {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return Objects.equals(uid, other.uid) && isBridge() == other.isBridge() && Objects.equals(bridge, other.bridge)
                ...
                && equalsConfig(config, other.config) && equalsChannels(channels, other.channels);
    }

    public static boolean equalsConfig(@Nullable Map<@NonNull String, @NonNull Object> first,
            @Nullable Map<@NonNull String, @NonNull Object> second) {
    ...
    private static boolean equalsConfigValue(@NonNull Object first, @Nullable Object second) {
