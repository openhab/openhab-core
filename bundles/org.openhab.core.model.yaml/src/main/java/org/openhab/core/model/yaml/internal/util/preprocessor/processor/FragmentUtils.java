 ...
 * for dealing with {@link IncludePlaceholder} and {@link InsertPlaceholder} parameters.
 *
...
public class FragmentUtils {
    ...
    public static record Parameters(@Nullable String name, @NonNull Map<String, @Nullable Object> varsMap) {
    }

    /**
     * Combines the placeholder variables into the current variables.
     * The current variables are included, and any variables defined on the
     * placeholder override them.
     */
    public static Map<String, @Nullable Object> combineInjectedVars(Map<String, @Nullable Object> injectedVars,
            Map<String, @Nullable Object> currentVars) {
        Map<String, @Nullable Object> combinedVars = new LinkedHashMap<>(currentVars);
        injectedVars.forEach((k, v) -> combinedVars.put(String.valueOf(k), v));
        return combinedVars;
    }
