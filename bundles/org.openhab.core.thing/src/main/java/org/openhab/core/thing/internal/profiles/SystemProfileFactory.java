...
public class SystemProfileFactory implements ProfileFactory, ProfileAdvisor, ProfileTypeProvider {
    ...
    private static final Set<ProfileType> SUPPORTED_PROFILE_TYPES = Set.of(DEFAULT_TYPE, FOLLOW_TYPE, OFFSET_TYPE,
            HYSTERESIS_TYPE, RAWBUTTON_ON_OFF_SWITCH_TYPE, RAWBUTTON_TOGGLE_PLAYER_TYPE, RAWBUTTON_TOGGLE_SWITCH_TYPE,
    ...
    private static final Set<ProfileTypeUID> SUPPORTED_PROFILE_TYPE_UIDS = Set.of(DEFAULT, FOLLOW, OFFSET, HYSTERESIS,
    ...
    public @Nullable Profile createProfile(ProfileTypeUID profileTypeUID, ProfileCallback callback,
        ...
        if (DEFAULT.equals(profileTypeUID)) {
            ...
            return new HysteresisStateProfile(callback, context);
