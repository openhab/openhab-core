...
public interface SystemProfiles {
    ...
    ProfileTypeUID BATTERY_LOW = new ProfileTypeUID(SYSTEM_SCOPE, "battery-low");
    ...
    StateProfileType OFFSET_TYPE = ProfileTypeBuilder.newState(OFFSET, "Offset")
            ...
            .build();
    ProfileType BATTERY_LOW_TYPE = ProfileTypeBuilder.newState(BATTERY_LOW, "Battery Low") //
