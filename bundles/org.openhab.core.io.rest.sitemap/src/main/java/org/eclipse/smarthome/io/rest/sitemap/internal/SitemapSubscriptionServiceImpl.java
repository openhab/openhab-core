...
@NonNullByDefault
public class SitemapSubscriptionServiceImpl
        implements ModelRepositoryChangeListener, EventSubscriber, SitemapSubscriptionService {
    ...
    private final Logger logger = LoggerFactory.getLogger(SitemapSubscriptionServiceImpl.class);
    ...
    public SitemapSubscriptionServiceImpl() {
    }
