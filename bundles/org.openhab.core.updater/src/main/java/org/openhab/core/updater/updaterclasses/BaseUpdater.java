...
public abstract class BaseUpdater implements Runnable {
    ...
    private VersionType targetNewVersionType = getActualVersionType();
     ...
     *
     * @param newVersionTypeString string representation of a target version i.e. STABLE, MILESTONE, SNAPSHOT
     ...
     */
    private static VersionType getActualVersionType() {
        String actVer = getActualVersion();
        if (VERSION_NOT_DEFINED.equals(actVer)) {
            return VersionType.UNKNOWN;
        }
        if (actVer.contains("M")) {
            return VersionType.MILESTONE;
        }
        if (actVer.contains(SNAPSHOT)) {
     ...
     * Execute the update script.
     * <p>
     * Calls either {@link org.openhab.core.updater.updaterclasses.BaseUpdater#runScriptViaProcessBuilder} or
     * {@link org.openhab.core.updater.updaterclasses.BaseUpdater#runScriptViaSshLoopback} as required.
     *
     * @return success
     */
     ...
     * {@link org.openhab.core.updater.updaterclasses.BaseUpdater#runScriptViaSshLoopback} must be used.
     *
     ...
     * <p>
     * On Linux systems {@link org.openhab.core.updater.updaterclasses.BaseUpdater#runScriptViaProcessBuilder} may
