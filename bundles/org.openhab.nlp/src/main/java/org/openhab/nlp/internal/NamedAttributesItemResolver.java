 ...
 * It uses semantic tags and additional monikers defined in metadata ("nlp" namespace).
 * <p>
 ...
 * with the "inheritTags" configuration property in the "nlp" metadata namespace.
 *
...
public class NamedAttributesItemResolver implements ItemResolver {
     ...
     * (non-Javadoc)
     *
     * @see org.openhab.nlp.internal.ItemResolver#setLocale(java.util.Locale)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.openhab.nlp.internal.ItemResolver#getAllItemNamedAttributes()
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see org.openhab.nlp.internal.ItemResolver#getMatchingItems(java.lang.String, java.lang.String)
     */
    @Override
    ...
    private void updateItemNamedAttributes() {
        ...
        for (Item item : itemRegistry.getAll()) {
            ...
            Metadata metadata = metadataRegistry.get(new MetadataKey("nlp", item.getName()));
            ...
            // look for additional comma-separated item monikers in the "nlp" metadata namespace
    ...
    private @NonNull RegistryChangeListener<Metadata> metadataRegistryChangeListener = new RegistryChangeListener<Metadata>() {
        ...
        public void added(Metadata element) {
            if (element.getUID().getNamespace() == "nlp") {
                logger.debug("Invalidating cached item named attributes");
                itemAttributes = null;
            }
        }
