...
class RulesFormatter extends AbstractDeclarativeFormatter {
	...
	override protected void configureFormatting(FormattingConfig c) {
        ...
        c.setLinewrap(1, 1, 2).after(getRuleAccess.andKeyword_7_4_0)
        c.setLinewrap(1, 1, 2).before(getRuleAccess.whenKeyword_4)
        c.setLinewrap(1, 1, 2).after(getRuleAccess.whenKeyword_4)
        c.setLinewrap(1, 1, 2).before(getRuleAccess.butKeyword_7_0)
        c.setLinewrap(1, 1, 2).after(getRuleAccess.ifKeyword_7_2)
        ...
        c.setIndentationDecrement.before(getRuleAccess.butKeyword_7_0)
        c.setIndentationIncrement.after(getRuleAccess.ifKeyword_7_2)
